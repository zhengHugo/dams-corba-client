 ...
 implements PatientOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("bookAppointment", new Integer (0));
    _methods.put ("getAppointmentSchedule", new Integer (1));
    _methods.put ("cancelAppointment", new Integer (2));
    _methods.put ("swapAppointment", new Integer (3));
  }
